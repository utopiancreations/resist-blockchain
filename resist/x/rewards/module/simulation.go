...
import (
	...
	rewardssimulation "resist/x/rewards/simulation"
...
func (am AppModule) WeightedOperations(simState module.SimulationState) []simtypes.WeightedOperation {
	...
	const (
		opWeightMsgRegisterNode          = "op_weight_msg_rewards"
	...
	operations = append(operations, simulation.NewWeightedOperation(
		...
		rewardssimulation.SimulateMsgRegisterNode(am.authKeeper, am.bankKeeper, am.keeper, simState.TxConfig),
	))
